...
class LessonGenerator:
    ...
    def generate_curriculum(self, subject: str, level: str, topic: str, prerequisites: str) -> List[str]:
        ...
        prompt = f"""As an expert {subject} educator teaching at {level} level, create a structured learning path for {topic}.
        Student background: {prerequisites}

        Create exactly 5 sequential subtopics that:
        1. Follow a clear learning progression
        2. Build on previous knowledge
        3. Lead to mastery of {topic}
        4. Are appropriate for {level} level
        5. Connect to real-world applications

        Format each subtopic as:
        1. [Subtopic Name] - [Brief description focusing on learning outcomes]
        2. [Subtopic Name] - [Brief description focusing on learning outcomes]
        etc.

        Ensure each subtopic:
        - Has a clear, specific focus
        - Builds on previous topics
        - Includes actionable learning outcomes
